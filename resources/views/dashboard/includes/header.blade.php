                ...
                <li class="nav-item">
                    <a class="navbar-brand" href="index.html">
                        {{-- <img class="brand-logo" alt="modern admin logo"
                             src="{{asset('assets/img/icon.jpg')}}"> --}}
                        <h3 class="brand-text">Jawhara Foods</h3>
                    </a>
                </li>
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right">
                    <li class="dropdown dropdown-user nav-item">
                        ...
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"> 
                            ...
                            <span class="mr-1 hidden">Profile                             
                    <span
                ...
                @endauth
                         ...
                         {{-- @auth
                         {{auth()->user()->name}} --}}
                         <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item hidden" href=""><i
                                    class="ft-user hidden"></i> edit profile </a>
