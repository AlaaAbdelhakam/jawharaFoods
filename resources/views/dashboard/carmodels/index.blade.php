                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <form action="{{ route('search.carmodels') }}" method="GET">
                                        ...
                                        <br>
                                        {{-- @role('developer') --}}
                                        <a href="{{ route('carmodel.restore.all') }}" class="btn btn-success">Restore All</a>
                                        {{-- @endrole --}}
                                        <br>
                                        <br>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                ...
                                                                <a href="{{route('admin.carmodel.edit',$model->id)}}"
                                                                   class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">تعديل</a>


                                                                <a href="{{route('admin.carmodel.delete',$model->id)}}"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="btn-group" role="group"
                                                                            ...
                                                                            <a href="{{ route('carmodel.restore', $task->id) }}"
